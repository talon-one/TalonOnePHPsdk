...
*ManagementApi* | [**scimGetServiceProviderConfig**](docs/Api/ManagementApi.md#scimgetserviceproviderconfig) | **GET** /v1/provisioning/scim/ServiceProviderConfig | Service config endpoint for SCIM provisioning protocol
