...
class CouponRejectionReason implements ModelInterface, ArrayAccess
{
    ...
    const REASON_COUPON_PART_OF_NOT_TRIGGERED_CAMPAIGN = 'CouponPartOfNotTriggeredCampaign';
    const REASON_COUPON_RESERVATION_REQUIRED = 'CouponReservationRequired';
    const REASON_PROFILE_REQUIRED = 'ProfileRequired';
