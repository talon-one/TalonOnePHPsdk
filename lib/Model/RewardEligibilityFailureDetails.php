 ...
 * @link     https://openapi-generator.tech
 */
class RewardEligibilityFailureDetails implements ModelInterface, ArrayAccess
{
    ...
    const FAILURE_CODE_CONDITION_NOT_MET = 'CONDITION_NOT_MET';
    const FAILURE_CODE_INSUFFICIENT_BALANCE = 'INSUFFICIENT_BALANCE';
    const FAILURE_CODE_CARD_REQUIRED = 'CARD_REQUIRED';
    const FAILURE_CODE_PROFILE_REQUIRED = 'PROFILE_REQUIRED';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['failureCode']) && !in_array($this->container['failureCode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'failureCode', must be one of '%s'",
