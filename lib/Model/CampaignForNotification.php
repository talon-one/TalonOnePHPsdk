...
/**
 * CampaignForNotification Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  TalonOne\Client
 ...
 * @link     https://openapi-generator.tech
 */
class CampaignForNotification implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignForNotification';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CampaignForNotification., must be bigger than or equal to 1.');
        }
