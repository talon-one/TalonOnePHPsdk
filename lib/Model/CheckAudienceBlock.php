 ...
 *
 * @category Class
 * @description A block that checks whether a given customer profile is a member of an audience.
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CheckAudienceBlock implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'operator' => 'string',
        'profile' => 'string',
        'audience' => '\TalonOne\Client\Model\CheckAudienceBlockAudience',
        'onFailure' => 'object[]'
    ];
    ...
    const OPERATOR_MEMBER = 'member';
    const OPERATOR_NOT_MEMBER = 'not(member)';
    const OPERATOR_JUST_JOINED = 'justJoined';
    const OPERATOR_JUST_LEFT = 'justLeft';
     ...
     * Gets audience
     *
     * @return \TalonOne\Client\Model\CheckAudienceBlockAudience
     */
     ...
     * Sets audience
     *
     * @param \TalonOne\Client\Model\CheckAudienceBlockAudience $audience audience
     *
     * @return $this
     */
