...
class Rule implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'title' => 'string',
        'description' => 'string',
        'bindings' => '\Swagger\Client\Model\Binding[]',
        'condition' => 'object[]',
        'effects' => 'object[][]'
    ];
     ...
     * Gets bindings
     *
     * @return \Swagger\Client\Model\Binding[]
     */
     ...
     * Sets bindings
     *
     * @param \Swagger\Client\Model\Binding[] $bindings An array that provides objects with variable names (name) and talang expressions to whose result they are bound (expression) during rule evaluation. The order of the evaluation is decided by the position in the array.
     *
     * @return $this
     */
     ...
     * Sets condition
     *
     * @param object[] $condition A Talang expression that will be evaluated in the context of the given event.
     *
     * @return $this
     */
