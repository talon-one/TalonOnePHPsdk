...
class User implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'policy' => 'map[string,\Swagger\Client\Model\Policy]',
        'release_update' => 'bool'
    ];
     ...
     * Sets last_activity
     *
     * @param \DateTime $last_activity Last time user used management API
     *
     * @return $this
     */
     ...
     * Gets policy
     *
     * @return map[string,\Swagger\Client\Model\Policy]
     */
     ...
     * Sets policy
     *
     * @param map[string,\Swagger\Client\Model\Policy] $policy Access policy for the user as json object.
     *
     * @return $this
     */
