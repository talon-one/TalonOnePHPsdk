...
/**
 * NewFeatureFlags Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NewFeatureFlags implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewFeatureFlags';
     ...
     * Sets loyalty
     *
     * @param bool|null $loyalty Whether the account has access to the loyalty features or not
     *
     * @return $this
     */
