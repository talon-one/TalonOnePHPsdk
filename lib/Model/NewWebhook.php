...
class NewWebhook implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewWebhook';
    ...
    protected static $swaggerTypes = [
        ...
        'headers' => 'string[]',
        'payload' => 'string',
        'params' => '\Swagger\Client\Model\TemplateArgDef[]',
        'enabled' => 'bool'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['verb'], $allowedValues)) {
    ...
    {
        $allowedValues = $this->getVerbAllowableValues();
        if (!in_array($verb, $allowedValues)) {
     ...
     * Sets payload
     *
     * @param string $payload API payload (supports templating using parameters) for this webhook
     *
     * @return $this
     */
     ...
     * Sets params
     *
     * @param \Swagger\Client\Model\TemplateArgDef[] $params Array of template argument definitions
     *
     * @return $this
     */
