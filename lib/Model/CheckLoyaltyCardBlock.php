 ...
 *
 * @category Class
 * @description A block that verifies whether a loyalty card is linked to the user&#39;s profile.
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CheckLoyaltyCardBlock implements ModelInterface, ArrayAccess
{
    ...
    const OPERATOR_LINKED = 'linked';
    const OPERATOR_NOT_LINKED = 'not(linked)';
