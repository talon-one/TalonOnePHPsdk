...
class CardLedgerTransactionLogEntryIntegrationAPI implements ModelInterface, ArrayAccess
{
    ...
    public function setCardIdentifier($cardIdentifier)
    {
        if ((mb_strlen($cardIdentifier) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cardIdentifier when calling CardLedgerTransactionLogEntryIntegrationAPI., must be smaller than or equal to 255.');
        }
