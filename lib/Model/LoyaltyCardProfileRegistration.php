 ...
 * @link     https://openapi-generator.tech
 */
class LoyaltyCardProfileRegistration implements ModelInterface, ArrayAccess
{
     ...
     * Sets integrationId
     *
     * @param string $integrationId Integration ID of the customer associated with the card.
     *
     * @return $this
     */
