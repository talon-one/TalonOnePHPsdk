...
/**
 * NewCampaignSetV2 Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  TalonOne\Client
 ...
 * @link     https://openapi-generator.tech
 */
class NewCampaignSetV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewCampaignSetV2';
    ...
    public function setVersion($version)
    {
        ...
        if (($version < 1)) {
            throw new \InvalidArgumentException('invalid value for $version when calling NewCampaignSetV2., must be bigger than or equal to 1.');
        }
