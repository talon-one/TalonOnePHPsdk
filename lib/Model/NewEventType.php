...
class NewEventType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewEventType';
    ...
    const MIME_TYPE_APPLICATIONX_WWW_FORM_URLENCODED = 'application/x-www-form-urlencoded';
    ...
    public function getMimeTypeAllowableValues()
    {
        return [
            ...
            self::MIME_TYPE_APPLICATIONX_WWW_FORM_URLENCODED,
            self::MIME_TYPE_NONE,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['mime_type'], $allowedValues)) {
        ...
        if (!in_array($this->container['handler_language'], $allowedValues)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getMimeTypeAllowableValues();
        if (!in_array($mime_type, $allowedValues)) {
     ...
     *
     * @param string $example_payload It is often helpful to include an example payload with the event type definition for documentation purposes.
     *
     * @return $this
     */
     ...
     * Sets schema
     *
     * @param object $schema It is strongly recommended to define a JSON schema that will be used to perform structural validation of request payloads after parsing.
     *
     * @return $this
     */
     ...
     *
     * @param string $handler_language The language of the handler code. Currently only `\"talang\"` is supported.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getHandlerLanguageAllowableValues();
        if (!is_null($handler_language) && !in_array($handler_language, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'handler_language', must be one of '%s'",
                    implode("', '", $allowedValues)
