...
class CartItemAdjustment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CartItemAdjustment';
    ...
    public function valid()
    {
        ...
        if ($this->container['remaining_price'] < 0) {
            return false;
        }
        return true;
    }
     ...
     *
     * @param float $remaining_price Remaining price in currency after payment in points has been made
     *
     * @return $this
     */
