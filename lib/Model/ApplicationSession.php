...
class ApplicationSession implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationSession';
    ...
    protected static $swaggerTypes = [
        ...
        'referral' => 'string',
        'state' => 'string',
        'cart_items' => '\Swagger\Client\Model\CartItem[]',
     ...
     * Sets profile_id
     *
     * @param int $profile_id The globally unique Talon.One ID of the customer that created this entity.
     *
     * @return $this
     */
     ...
     * Sets referral
     *
     * @param string $referral Any referal code entered.
     *
     * @return $this
     */
     ...
     * Sets cart_items
     *
     * @param \Swagger\Client\Model\CartItem[] $cart_items Serialized JSON representation.
     *
     * @return $this
     */
