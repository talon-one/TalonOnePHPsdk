...
class CardLedgerTransactionLogEntry implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['cardIdentifier']) > 255)) {
            $invalidProperties[] = "invalid value for 'cardIdentifier', the character length must be smaller than or equal to 255.";
        }

        if ($this->container['customerSessionId'] === null) {
            $invalidProperties[] = "'customerSessionId' can't be null";
        }
        if ((mb_strlen($this->container['customerSessionId']) > 255)) {
     ...
     * Sets cardIdentifier
     *
     * @param string $cardIdentifier Identifier of the loyalty card.
     *
     * @return $this
     */
    public function setCardIdentifier($cardIdentifier)
    {
        if ((mb_strlen($cardIdentifier) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cardIdentifier when calling CardLedgerTransactionLogEntry., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string $customerSessionId ID of the customer session where the transaction occurred.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of transaction. Possible values are:   - `addition`: Points were added.   - `subtraction`: Points were subtracted.
     *
     * @return $this
     */
     ...
     * Sets startDate
     *
     * @param string $startDate Date when points become active. Possible values are:   - `immediate`: Points are active immediately.   - `timestamp value`: Points become active from the given date.
     *
     * @return $this
     */
