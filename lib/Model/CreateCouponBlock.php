 ...
 * @link     https://openapi-generator.tech
 */
class CreateCouponBlock implements ModelInterface, ArrayAccess
{
     ...
     * Sets campaignId
     *
     * @param object $campaignId The ID of the campaign in which the coupon code is created.
     *
     * @return $this
     */
     ...
     * Sets usageLimit
     *
     * @param object|null $usageLimit The number of times the coupon code can be redeemed. `0` means unlimited redemptions, but any campaign usage limits still apply. Either a numeric scalar or a `{{expression}}` string that resolves to a number at evaluation time.
     *
     * @return $this
     */
     ...
     * Sets discountLimit
     *
     * @param object|null $discountLimit The total discount value that the code can give. Typically used to represent a gift card value. Either a numeric scalar or a `{{expression}}` string that resolves to a number at evaluation time.
     *
     * @return $this
     */
     ...
     * Sets startDate
     *
     * @param object|null $startDate Timestamp at which point the coupon becomes valid.
     *
     * @return $this
     */
     ...
     * Sets expiryDate
     *
     * @param object|null $expiryDate Expiration date of the coupon. Coupon never expires if this is omitted.
     *
     * @return $this
     */
     ...
     * Sets attributes
     *
     * @param object|null $attributes Custom attributes associated with this coupon code.
     *
     * @return $this
     */
