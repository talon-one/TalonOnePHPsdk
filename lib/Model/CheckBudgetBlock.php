 ...
 *
 * @category Class
 * @description A block that verifies if a specific budget has sufficient limit available, and whether this limit meets or exceeds a specific value.
 * @package  TalonOne\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CheckBudgetBlock implements ModelInterface, ArrayAccess
{
    ...
    const OPERATOR_AVAILABLE = 'available';
    const OPERATOR_ENOUGH_FOR = 'enoughFor';
