 ...
 * @link     https://openapi-generator.tech
 */
class PassthroughBlock implements ModelInterface, ArrayAccess
{
     ...
     * Sets expression
     *
     * @param object[] $expression The raw Talang expression as an array. For a function call, the first element is the function name and subsequent elements are its arguments. For any other expression (for example a bare attribute path or a literal value), this is a single-element array containing that value.
     *
     * @return $this
     */
