 ...
 * @link     https://openapi-generator.tech
 */
class RoleV2RolesGroup implements ModelInterface, ArrayAccess
{
     ...
     * Gets applications
     *
     * @return map[string,\TalonOne\Client\Model\RoleV2ApplicationDetails]|null
     */
     ...
     * Sets applications
     *
     * @param map[string,\TalonOne\Client\Model\RoleV2ApplicationDetails]|null $applications A map of the link between the Application, campaign, or draft campaign-related permission set and the Application ID the permissions apply to.
     *
     * @return $this
     */
     ...
     *
     * @param map[string,string]|null $loyaltyPrograms A map of the link between the loyalty program-related permission set and the Application ID the permissions apply to.
     *
     * @return $this
     */
     ...
     *
     * @param map[string,string]|null $campaignAccessGroups A map of the link between the campaign access group-related permission set and the Application ID the permissions apply to.
     *
     * @return $this
     */
