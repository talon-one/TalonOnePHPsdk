...
class NewLoyaltyProgram implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewLoyaltyProgram';
    ...
    public function setName($name)
    {
        ...
        if ((strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NewLoyaltyProgram., must be bigger than or equal to 1.');
        }
    ...
    public function setPointValidity($point_validity)
    {
        ...
        if (($point_validity < 1)) {
            throw new \InvalidArgumentException('invalid value for $point_validity when calling NewLoyaltyProgram., must be bigger than or equal to 1.');
        }
