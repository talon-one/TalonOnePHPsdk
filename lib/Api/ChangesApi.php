...
class ChangesApi
{
     ...
     */
    public function getChanges($page_size = null, $skip = null, $sort = null)
    {
        list($response) = $this->getChangesWithHttpInfo($page_size, $skip, $sort);
        return $response;
    }
     ...
     */
    public function getChangesWithHttpInfo($page_size = null, $skip = null, $sort = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20026';
        $request = $this->getChangesRequest($page_size, $skip, $sort);
     ...
     */
    public function getChangesAsync($page_size = null, $skip = null, $sort = null)
    {
        return $this->getChangesAsyncWithHttpInfo($page_size, $skip, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChangesAsyncWithHttpInfo($page_size = null, $skip = null, $sort = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20026';
        $request = $this->getChangesRequest($page_size, $skip, $sort);
     ...
     */
    protected function getChangesRequest($page_size = null, $skip = null, $sort = null)
    {
