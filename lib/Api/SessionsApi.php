...
class SessionsApi
{
     ...
     * Create a Session
     *
     * @param  \Swagger\Client\Model\LoginParams $body body (optional)
     *
     ...
     * Create a Session
     *
     * @param  \Swagger\Client\Model\LoginParams $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createSessionAsync($body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\Session';
        $request = $this->createSessionRequest($body);
     ...
     */
    protected function createSessionRequest($body = null)
    {
