...
> \TalonOne\Client\Model\ActivateLoyaltyPointsResponse activateLoyaltyPoints($loyaltyProgramId, $body)
...
$body = new \TalonOne\Client\Model\ActivateLoyaltyPoints(); // \TalonOne\Client\Model\ActivateLoyaltyPoints | body

try {
    $result = $apiInstance->activateLoyaltyPoints($loyaltyProgramId, $body);
    print_r($result);
} catch (Exception $e) {
 ...
 **body** | [**\TalonOne\Client\Model\ActivateLoyaltyPoints**](../Model/ActivateLoyaltyPoints.md)| body |
...
> \TalonOne\Client\Model\BestPriorPrice[] bestPriorPrice($body)
...
$body = new \TalonOne\Client\Model\BestPriorPriceRequest(); // \TalonOne\Client\Model\BestPriorPriceRequest | body

try {
    $result = $apiInstance->bestPriorPrice($body);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\TalonOne\Client\Model\BestPriorPriceRequest**](../Model/BestPriorPriceRequest.md)| body |
...
$integrationId = 'integrationId_example'; // string | The integration ID of the customer profile. You can get the `integrationId` of a profile using: - A customer session integration ID with the [Update customer session](https://docs.talon.one/integration-api#tag/Customer-sessions/operation/updateCustomerSessionV2) endpoint. - The Management API with the [List application's customers](https://docs.talon.one/management-api#tag/Customer-data/operation/getApplicationCustomers) endpoint.
$body = new \TalonOne\Client\Model\DeleteLoyaltyTransactionsRequest(); // \TalonOne\Client\Model\DeleteLoyaltyTransactionsRequest | 
 ...
 **integrationId** | **string**| The integration ID of the customer profile. You can get the &#x60;integrationId&#x60; of a profile using: - A customer session integration ID with the [Update customer session](https://docs.talon.one/integration-api#tag/Customer-sessions/operation/updateCustomerSessionV2) endpoint. - The Management API with the [List application&#39;s customers](https://docs.talon.one/management-api#tag/Customer-data/operation/getApplicationCustomers) endpoint. |
 **body** | [**\TalonOne\Client\Model\DeleteLoyaltyTransactionsRequest**](../Model/DeleteLoyaltyTransactionsRequest.md)|  |
...
> \TalonOne\Client\Model\InlineResponse2003 getCustomerAchievementHistory($integrationId, $achievementId, $progressStatus, $startDate, $endDate, $pageSize, $skip)
...
> \TalonOne\Client\Model\InlineResponse2002 getCustomerAchievements($integrationId, $campaignIds, $achievementIds, $achievementStatus, $currentProgressStatus, $pageSize, $skip)
...
> \TalonOne\Client\Model\InlineResponse2006 getLoyaltyCardPoints($loyaltyProgramId, $loyaltyCardId, $status, $subledgerId, $customerSessionIDs, $transactionUUIDs, $pageSize, $skip, $sort)
...
> \TalonOne\Client\Model\InlineResponse2004 getLoyaltyCardTransactions($loyaltyProgramId, $loyaltyCardId, $subledgerId, $loyaltyTransactionType, $startDate, $endDate, $customerSessionIDs, $transactionUUIDs, $pageSize, $skip, $awaitsActivation)
...
> \TalonOne\Client\Model\InlineResponse2007 getLoyaltyProgramProfilePoints($loyaltyProgramId, $integrationId, $status, $subledgerId, $customerSessionIDs, $transactionUUIDs, $pageSize, $skip, $sort)
...
> \TalonOne\Client\Model\InlineResponse2005 getLoyaltyProgramProfileTransactions($loyaltyProgramId, $integrationId, $customerSessionIDs, $transactionUUIDs, $subledgerId, $loyaltyTransactionType, $startDate, $endDate, $pageSize, $skip, $awaitsActivation)
...
> \TalonOne\Client\Model\InlineResponse2001 getReservedCustomers($couponValue)
...
> \TalonOne\Client\Model\IntegrationStateV2 returnCartItems($customerSessionId, $body, $dry, $runRuleEngine)
...
try {
    $result = $apiInstance->returnCartItems($customerSessionId, $body, $dry, $runRuleEngine);
    print_r($result);
} catch (Exception $e) {
...
> \TalonOne\Client\Model\IntegrationEventV2Response trackEventV2($body, $silent, $dry, $forceCompleteEvaluation)
...
> \TalonOne\Client\Model\LoyaltyCard unlinkLoyaltyCardFromProfile($loyaltyProgramId, $loyaltyCardId, $body)
...
try {
    $result = $apiInstance->unlinkLoyaltyCardFromProfile($loyaltyProgramId, $loyaltyCardId, $body);
    print_r($result);
} catch (Exception $e) {
